let g:Powerline#Matches#matches = {
	...
	\ 'lustyexplorer_buffers'
    \                   : Pl#Match#Add('bufname("%")', '\[LustyExplorer-Buffers\]'),
	\ 'lustyexplorer_buffergrep'
    \                   : Pl#Match#Add('bufname("%")', '\[LustyExplorer-BufferGrep\]'),
	\ 'lustyexplorer_files'
    \                   : Pl#Match#Add('bufname("%")', '\[LustyExplorer-Files\]'),
